                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button
                            ...
                            data-id_permission="{{$list_permissionBrochure->id_permission_brochure}}"
                            data-id_directeur="{{$list_permissionBrochure->id_directeur}}">
                            Refuser
                        </button>
    ...
    document.querySelectorAll('.btn-refuser').forEach(button => {
        button.addEventListener('click', async function () {
            ...
            try {
                ...
                let response1 = await fetch("{{ route('refusDeBrochure') }}", {
                    method: "POST",
                    headers: {
