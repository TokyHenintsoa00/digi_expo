...
@section('planificationTemoignageSection')
    ...
    <div class="col-md-12">
        <div class="card shadow mb-4">
            <div class="card-header">
                <h5 class="card-title fw-semibold mb-4">Planification de Temoignage </h5>
            </div>
            <div class="card-body">
                  <!-- Afficher le message de succès -->
                   ...
                   @endif
                <form action="{{route('permissionTemoignage')}}" method="POST">
                    @csrf
                    <div class="form-row">
