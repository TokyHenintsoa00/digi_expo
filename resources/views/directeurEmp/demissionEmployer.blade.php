    ...
    <table class="table table-striped ">
        <thead>
            <tr>
                ...
                <th>Mail</th>
                <th>justification de demission</th>
            </tr>
        </thead>
        <tbody>
            @foreach ($demissionEmp as $list_demissionEmp)
                <tr>
                    ...
                    <td>
                        ...
                        data-id_emp="{{$list_demissionEmp->id_emp}}">Valider la démission
                        </button>
                    </td>
                    @else
                        ...
                        <div class="d-flex align-items-center gap-2">
                            <p class="text-danger fw-semibold">Demissionner</p>
                        </div>
...
<script>
    $(document).ready(function() {
        $('.demission-btn').on('click', function(e) {
            ...
            // let justification_demission = $('#justification_demission').val();
            ...
            if (id_emp != null) {
                Swal.fire({
                    title: "Êtes-vous sûr?",
                    text: "Voulez-vous vraiment vous demissioner?",
                    icon: "warning",
                    showCancelButton: true,
                    confirmButtonColor: '#d33',
                    cancelButtonColor: '#3085d6',
                    confirmButtonText: 'Oui, valider la demission',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                Swal.fire({
                                    icon: 'success',
                                    title: "Succès",
                                    text: "envoie de demission chez votre superieur vous recevrez un mail apres validation.",
